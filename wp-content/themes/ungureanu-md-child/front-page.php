 ...
 *
 * Starter template: elementor-starters/acasa.json
 *
 * Note: the plugin CTA strip (gu-cta-rebuilt, injected at wp_footer
 * priority 20) continues to appear above the footer regardless.
 */
		...
		<main id="content" class="gu-elementor-page"
			...
			<div style="padding:72px 32px;text-align:center;background:#F2F2F7;
				...
				<p style="color:#A1A1A6;font-size:12px;margin:16px 0 0">
					Import starter: <code>elementor-starters/acasa.json</code>
				</p>
			</div>
			<?php endif; ?>
