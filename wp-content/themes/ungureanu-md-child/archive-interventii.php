<?php
/**
 * Archive — Intervenții neurochirurgicale
 * URL: /interventii/
 */
...
<main class="gu-archive" aria-label="Intervenții neurochirurgicale">

	<div class="gu-archive__header">
		<div class="gu-archive__header-inner">
			<p class="gu-archive__overline">Neurochirurgie</p>
			<h1 class="gu-archive__title">Intervenții neurochirurgicale</h1>
			<p class="gu-archive__desc">
				Proceduri chirurgicale moderne — de la tehnici minim invazive la intervenții complexe
				la nivelul coloanei vertebrale și al sistemului nervos.
			</p>
		</div>
	</div>
	...
	<div class="gu-archive__body">
		...
		<div class="gu-archive-grid">
			...
			<a href="<?php the_permalink(); ?>" class="gu-archive-card">
				...
				$summary = $has_acf
					? wp_strip_all_tags( (string) get_field( 'field_sp_short_summary' ) )
					: '';
				if ( ! $summary ) {
		...
		<div class="gu-archive-empty-state">
			...
			<p class="gu-archive-empty-state__text">
				Procedurile chirurgicale vor fi documentate în curând.
			</p>
